...
print("=" * 60)
print("Starting Training (Gemma 3 12B Pt - Unsloth Optimized)")
print("=" * 60)
...
MODEL_NAME    = "unsloth/gemma-3-12b-pt-bnb-4bit" 
MAX_SEQ_LEN   = 2048
OUTPUT_DIR    = "./gemma_3_12b_pt_medical_finetuned"
TOKENIZER_DIR = "./gemma_3_12b_pt_medical_tokenizer"
TEST_SIZE     = 0.05
SEED          = 3407
