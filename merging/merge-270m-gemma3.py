...
BASE_MODEL_NAME = "unsloth/gemma-3-270m"
ADAPTER_DIR     = "gemma_3_270m_endo_finetuned" # make sure to have both lora adaptor with its tokenizer in the same dir.
MERGED_DIR      = "gemma_3_270m_endo_finetuned_merged_fp16"
MAX_SEQ_LEN     = 2048
...
print("✅ Merge complete! You now have a standalone Gemma‑3‑270m Endo model.")
