...
BASE_MODEL_NAME = "unsloth/gemma-3-1b-pt"
ADAPTER_DIR     = "gemma_3_1b_endo_finetuned" # make sure to have both lora adaptor with its tokenizer in the same dir.
MERGED_DIR      = "gemma_3_1b_endo_finetuned_merged_fp16"
MAX_SEQ_LEN     = 2048
...
print("✅ Merge complete! You now have a standalone Gemma‑3‑1B Endo model.")
