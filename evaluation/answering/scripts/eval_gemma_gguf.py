...
def main():
    ...
    ap.add_argument("--out_dir", default="./harrison_gemma_gguf")
    ...
    # CHANGED: Removed 'include_baselines=False' argument below
    ...
    specs = filter_specs(specs_all, family="gemma", kind="gguf")
