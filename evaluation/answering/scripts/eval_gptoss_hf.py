...
def main():
    ...
    ap.add_argument("--out_dir", default="./harrison_gptoss_hf")
    ...
    # CHANGED: Removed 'include_baselines=True' argument below
    ...
    specs = filter_specs(specs_all, family="gptoss", kind="hf")
    ...
    run_eval(df, specs, out_dir=args.out_dir, resume=args.resume,
             load_in_4bit=args.load_in_4bit, max_new_tokens=args.max_new_tokens,
